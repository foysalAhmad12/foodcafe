...
<div class="wfs-cart-totals-container">
	...
	<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
		...
		<div class="wfs-cart-totals-item">
			<div class="wfs-cart-totals-item-left"><?php esc_html_e( 'Shipping', 'woocommerce' ); ?></div>
			<div class="fs-text-right" data-title="<?php esc_attr_e( 'Shipping', 'woocommerce' ); ?>"><?php woocommerce_shipping_calculator(); ?></div>
		</div>
